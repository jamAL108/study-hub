...
genai.configure(api_key="AIzaSyAsi474NfYaPT1nBU24huFKWQtghZ0R74c")
config = {
  'temperature': 0,
  'top_k': 20,
  'top_p': 0.9,
...
def generate_mcq():
    ...
    docs = "Replace with your logic for fetching documents"
    ...
    {"role": "user", "content": f"{extractedText}\n Generate one MCQ question from the above context. Don't repeat these questions: \n{questions}\n Keep in mind that the generated options should not be more than 15 words. The difficulty of questions should be moderate."}
    ]
