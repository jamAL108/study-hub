  ...
  return (
    <div className="flex-1 flex flex-col items-center">
      ...
      <div className="w-[min(90vw,1400px)] flex flex-col items-center py-16">
        ...
        <h2 className="mt-12 w-[40%] text-center text-muted-foreground"><span className="text-primary">StudyHub</span> Your secure, AI-powered space for enhanced learning and controlled data management.</h2>
      ...
      <div className="w-[min(90vw,1400px)] flex flex-col relative h-[100vh] items-center">
        ...
        <img src='/images/Group_72.png'  alt='sxdfvg' className="w-[67%] shadow-[0px_12px_102px_-11px_rgba(109,40,217,0.20)] h-[550px] " />
      </div>
    </div>
  );
}
