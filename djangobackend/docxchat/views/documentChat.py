...
class documentChat(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            meow = """You can create custom themes for your Instagram chats and your Instagram feed: 
Chat themes
You can create a custom theme for your Instagram chats using Meta AI: 
Tap the top right of your feed 
Tap a conversation in your inbox 
Tap the chat name at the top, then tap Theme 
Tap Create 
Enter a description or tap to enter a suggested description 
Tap in the bottom right to create your theme 
Tap Create in the bottom right to apply the theme to your ch"""
            return JsonResponse({"success": True, 'text':meow},status=200)
